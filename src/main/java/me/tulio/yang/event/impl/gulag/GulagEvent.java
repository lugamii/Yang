package me.tulio.yang.event.impl.gulag;
...
public class GulagEvent implements Event {
	...
	public String getDisplayName() {
		return CC.translate(Yang.get().getEventsConfig().getString("EVENTS.GULAG.DISPLAYNAME"));
	}

	@Override
	public List<String> getDescription() {
		return Yang.get().getEventsConfig().getStringList("EVENTS.GULAG.DESCRIPTION");
	}
	...
	public ItemStack getIcon() {
		return new ItemBuilder(Material.valueOf(Yang.get().getEventsConfig().getString("EVENTS.GULAG.ICON"))).build();
	}

	@Override
	public boolean canHost(Player player) {
		return player.hasPermission("yang.event.host.gulag");
	}
