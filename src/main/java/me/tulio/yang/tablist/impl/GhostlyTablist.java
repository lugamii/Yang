...
public class GhostlyTablist {
    ...
    public void update() {
        ...
        //Footer and Header
        if ((PlayerUtil.getPlayerVersion(player) != PlayerVersion.v1_7) && (instance.getAdapter().getHeader(player) != null || instance.getAdapter().getFooter(player) != null)) {
            List<String> header = instance.getAdapter().getHeader(player) == null ? Lists.newArrayList() : instance.getAdapter().getHeader(player);
            List<String> footer = instance.getAdapter().getFooter(player) == null ? Lists.newArrayList() : instance.getAdapter().getFooter(player);
