package me.tulio.yang.utilities.file.type;

import com.google.common.io.Files;
import me.tulio.yang.Yang;
import me.tulio.yang.utilities.file.AbstractConfigurationFile;
...
public class BasicConfigurationFile extends AbstractConfigurationFile {
    ...
    public void reload(){
        File file = new File(Yang.get().getDataFolder(), getName() + ".yml");
        try {
    ...
    public void save() {
        File folder = Yang.get().getDataFolder();
        try {
