...
public class CountdownBuilder {
    ...
    public CountdownBuilder withMessage(final Locale locale) {
        this.locale = locale;
        return this;
    }
    ...
    public Countdown start() {
       // Preconditions.checkNotNull((Object) this.message, "Message cannot be null!");
        ...
        return new Countdown(this.seconds, this.locale, this.tickHandler, this.broadcastHandler, this.finishHandler, this.messageFilter, playerList, this.convertIntegers(this.broadcastAt));
    }
